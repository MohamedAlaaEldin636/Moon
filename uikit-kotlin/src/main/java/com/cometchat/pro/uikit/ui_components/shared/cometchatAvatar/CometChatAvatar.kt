...
@BindingMethods(
  value = [BindingMethod(
    type = CometChatAvatar::class,
    attribute = "app:avatar",
    method = "setAvatar"
  ), BindingMethod(
    type = CometChatAvatar::class,
    attribute = "app:avatar_name",
    method = "setInitials"
  )]
)
class CometChatAvatar : AppCompatImageView {
  private val TAG = CometChatAvatar::class.java.simpleName

  private val avatar: Class<*> = CometChatAvatar::class.java
  ...
  protected fun init() {
    ...
    color = if (UIKitSettings.color != null && UIKitSettings.color.isEmpty()) Color.parseColor(
      UIKitSettings.color
...
//    }
  ...
  private fun setValues() {
    Log.d(TAG, "setValues: ${avatarUrl}")
    if (avatarUrl != null && !avatarUrl!!.isEmpty()) {
      if (context != null && !loadedBefore) {
        loadedBefore = true
        ...
        Glide.with(this).load(avatarUrl).apply(options).into(this)
